...
The Ruby SDK for the Pagespeed API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `PagespeedError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Pagespeed_sdk.rb       -- Main SDK module
