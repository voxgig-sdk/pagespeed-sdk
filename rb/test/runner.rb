...
module PagespeedTestRunner
  ...
  def self.env_override(m)
    live = getenv("PAGESPEED_TEST_LIVE")
    override = getenv("PAGESPEED_TEST_OVERRIDE")
    ...
    explain = getenv("PAGESPEED_TEST_EXPLAIN")
    m["PAGESPEED_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PagespeedTestRunner
Helpers = PagespeedHelpers
Vs = VoxgigStruct
