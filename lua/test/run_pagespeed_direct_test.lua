...
describe("RunPagespeedDirect", function()
  it("should direct-load-run_pagespeed", function()
    local setup = run_pagespeed_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-run_pagespeed", setup.live and "live" or "unit")
...
function run_pagespeed_direct_setup(mockres)
