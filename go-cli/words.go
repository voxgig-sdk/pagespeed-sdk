...
func registerSDKWords(r *eng.Registry, client *sdk.PagespeedSDK) {
...
func runOp(client *sdk.PagespeedSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
