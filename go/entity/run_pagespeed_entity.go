...
func NewRunPagespeedEntity(client *core.PagespeedSDK, entopts map[string]any) *RunPagespeedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RunPagespeedEntity) GetName() string { return e.name }
...
func (e *RunPagespeedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RunPagespeedEntity) Deleted() bool {
	return e.deleted
}


func (e *RunPagespeedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRunPagespeedEntity(e.client, opts)
}

func (e *RunPagespeedEntity) Data(args ...any) any {
...
func (e *RunPagespeedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RunPagespeed; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RunPagespeedEntity) DataTyped(data ...RunPagespeed) RunPagespeed {
	if len(data) > 0 {
		return typedFrom[RunPagespeed](e.Data(asMap(data[0])))
	}
	return typedFrom[RunPagespeed](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RunPagespeed (all fields
// optional at the wire level).
func (e *RunPagespeedEntity) MatchTyped(match ...RunPagespeed) RunPagespeed {
	if len(match) > 0 {
		return typedFrom[RunPagespeed](e.Match(asMap(match[0])))
	}
	return typedFrom[RunPagespeed](e.Match())
}
...
func (e *RunPagespeedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RunPagespeedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RunPagespeedLoadMatch and returns an RunPagespeed. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RunPagespeedEntity) LoadTyped(reqmatch RunPagespeedLoadMatch, ctrl map[string]any) (RunPagespeed, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RunPagespeed{}, err
	}
	return typedFrom[RunPagespeed](res), nil
}



func (e *RunPagespeedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RunPagespeedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RunPagespeedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RunPagespeedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RunPagespeedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
