...
func (sdk *PagespeedSDK) OptionsMap() map[string]any {
...
func (sdk *PagespeedSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PagespeedSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PagespeedSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PagespeedSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PagespeedSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PagespeedSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PagespeedSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PagespeedSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PagespeedSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PagespeedSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
