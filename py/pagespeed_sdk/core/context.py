...
from pagespeed_sdk.core.helpers import get_ctx_prop, to_map
...
class PagespeedContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, PagespeedSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PagespeedResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PagespeedResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PagespeedError(code, msg, self)
