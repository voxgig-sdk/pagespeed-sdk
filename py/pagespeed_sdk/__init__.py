...
from pagespeed_sdk.utility import register

# Load features
from pagespeed_sdk.feature.base_feature import PagespeedBaseFeature
from pagespeed_sdk.features import _has_feature, _make_feature
...
class PagespeedSDK:
    ...
    def get_utility(self):
        return PagespeedUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PagespeedSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def RunPagespeed(self, data=None) -> "RunPagespeedEntity":
        ...
        from pagespeed_sdk.entity.run_pagespeed_entity import RunPagespeedEntity
