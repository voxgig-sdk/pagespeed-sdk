# Pagespeed SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PagespeedSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PagespeedSDK(...) and PagespeedSDK.test(...) become
#      PagespeedSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pagespeed_sdk"
_SDK_CLASS = "PagespeedSDK"
