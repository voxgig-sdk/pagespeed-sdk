# Pagespeed Python SDK



The Python SDK for the Pagespeed API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.RunPagespeed()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/pagespeed-sdk/releases)) or
...
```python
client = PagespeedSDK.test(testopts, sdkopts)
```
...
```
py/
├── pagespeed_sdk.py         -- Main SDK module
...
The main module (`pagespeed_sdk`) exports the SDK class.
