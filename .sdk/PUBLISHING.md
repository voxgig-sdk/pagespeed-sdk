...
|---|---|---|
| `ts/` | @voxgig-sdk/pagespeed-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/pagespeed-sdk \
      --repository voxgig-sdk/pagespeed-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/pagespeed-sdk` shows it, and
`npm trust revoke @voxgig-sdk/pagespeed-sdk --id=<id>` removes it.
