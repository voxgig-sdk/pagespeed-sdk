...
class PagespeedGraphql
{
    ...
    // equivalent.
    public static function body(PagespeedContext $ctx): mixed
    {
    ...
    public static function errors(PagespeedContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
