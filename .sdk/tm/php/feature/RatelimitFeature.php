...
// Pagespeed SDK ratelimit feature
...
class PagespeedRatelimitFeature extends PagespeedBaseFeature
{
    ...
    private function _acquire(PagespeedContext $ctx): void
    {
    ...
    private function _track(PagespeedContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
