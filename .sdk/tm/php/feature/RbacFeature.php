...
class PagespeedRbacFeature extends PagespeedBaseFeature
{
    ...
    private function _required(PagespeedContext $ctx): ?string
    {
    ...
    private function _reject(PagespeedContext $ctx, string $required): void
    {
    ...
    private function _track(PagespeedContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
