...
class PagespeedProxyFeature extends PagespeedBaseFeature
{
    ...
    public function init(PagespeedContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PagespeedContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
