...
// Pagespeed SDK streaming feature
...
class PagespeedStreamingFeature extends PagespeedBaseFeature
{
    ...
    private function _iterate(PagespeedResult $result): \Generator
    {
    ...
    private function _streamable(PagespeedContext $ctx): bool
    {
