...
// Pagespeed SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PagespeedOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PagespeedOmni::structfix($now, Struct::undef()))
                        !== json_encode(PagespeedOmni::structfix($val, Struct::undef()))) {
