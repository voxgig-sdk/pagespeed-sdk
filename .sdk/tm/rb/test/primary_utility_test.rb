...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = PagespeedOmni.make_runner(TEST_JSON_FILE, PagespeedSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : PagespeedOmni.errify(err)
    end
