...
function envOverride(m) {
    if ('TRUE' === process.env.PAGESPEED_TEST_LIVE ||
        'TRUE' === process.env.PAGESPEED_TEST_OVERRIDE) {
    ...
    m.PAGESPEED_TEST_EXPLAIN = process.env.PAGESPEED_TEST_EXPLAIN || m.PAGESPEED_TEST_EXPLAIN;
    return m;
}
