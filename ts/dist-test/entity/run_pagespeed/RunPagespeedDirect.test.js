...
(0, node_test_1.describe)('RunPagespeedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PagespeedSDK({
    ...
    (0, node_test_1.test)('direct-load-run_pagespeed', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-run_pagespeed', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PagespeedSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.PAGESPEED_APIKEY,
        }));
        let idmap = env['PAGESPEED_TEST_RUN_PAGESPEED_ENTID'];
    ...
    const client = new __1.PagespeedSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RunPagespeedDirect.test.js.map