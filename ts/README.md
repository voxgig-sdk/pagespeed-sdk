# Pagespeed TypeScript SDK



The TypeScript SDK for the Pagespeed API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.RunPagespeed()` — each with a small set of operations (`load`)
...
- Releases: [https://github.com/voxgig-sdk/pagespeed-sdk/releases](https://github.com/voxgig-sdk/pagespeed-sdk/releases)
...
```ts
const client = new PagespeedSDK({ apikey: '...' })
...
| `RunPagespeed(data?)` | `RunPagespeedEntity` | Create a RunPagespeed entity instance. |
| `tester(testopts?, sdkopts?)` | `PagespeedSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PagespeedSDK.test(testopts?, sdkopts?)` | `PagespeedSDK` | Create a test-mode client. |
...
```ts
const run_pagespeed = await client.RunPagespeed().load({ url: 'url' })
```
...
pagespeed/
├── src/
│   ├── PagespeedSDK.ts        # Main SDK class
...
await runpagespeed.load({ url: "example" })
