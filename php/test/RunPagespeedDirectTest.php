...
class RunPagespeedDirectTest extends TestCase
{
    public function test_direct_load_run_pagespeed(): void
    {
        $setup = run_pagespeed_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-run_pagespeed", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
