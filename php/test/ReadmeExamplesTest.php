...
// Pagespeed SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PagespeedSDK::test)
...
{
    private const SDK_CLASS = 'PagespeedSDK';
    ...
    private const SDK_BASE = 'pagespeed_sdk';
