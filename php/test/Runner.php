...
class PagespeedTestRunner
{
    ...
    {
        $live = self::getenv('PAGESPEED_TEST_LIVE');
        $override = self::getenv('PAGESPEED_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PAGESPEED_TEST_EXPLAIN');
...
class_alias('PagespeedTestRunner', 'Runner');
class_alias('PagespeedHelpers', 'Helpers');
