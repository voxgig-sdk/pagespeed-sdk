...
class PagespeedCacheFeature extends PagespeedBaseFeature
{
    ...
    private function _through(PagespeedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
