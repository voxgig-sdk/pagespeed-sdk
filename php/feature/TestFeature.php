...
// Pagespeed SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PagespeedTestFeature extends PagespeedBaseFeature
{
    ...
    public function init(PagespeedContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PagespeedContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PagespeedParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PagespeedContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PagespeedContext $ctx, $op, $args): array
    {
