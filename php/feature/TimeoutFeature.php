...
class PagespeedTimeoutFeature extends PagespeedBaseFeature
{
    ...
    private function _with_timeout(PagespeedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PagespeedContext $_ctx, float $ms): void
    {
        $client = $this->client;
