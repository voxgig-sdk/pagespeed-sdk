...
// Pagespeed SDK clienttrack feature
...
class PagespeedClienttrackFeature extends PagespeedBaseFeature
{
    ...
    public function PostConstruct(PagespeedContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pagespeed-SDK';
