...
// Pagespeed SDK utility: fetcher

class PagespeedFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PagespeedSDK/1.0)';
    ...
    public static function call(PagespeedContext $ctx, string $fullurl, array $fetchdef): array
    {
