...
// Pagespeed SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PagespeedTransformResponse
{
    public static function call(PagespeedContext $ctx): mixed
    {
        ...
        $transform = PagespeedHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
