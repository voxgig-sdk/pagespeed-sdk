...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/pagespeed` | `npm install @voxgig-sdk/pagespeed` |
| Python | `voxgig-sdk-pagespeed` | `pip install voxgig-sdk-pagespeed` |
| PHP | `voxgig-sdk/pagespeed` | `composer require voxgig-sdk/pagespeed` |
| Golang | `github.com/voxgig-sdk/pagespeed-sdk/go` | `go get github.com/voxgig-sdk/pagespeed-sdk/go` |
| Ruby | `voxgig-sdk-pagespeed` | `gem install voxgig-sdk-pagespeed` |
| Lua | `voxgig-sdk-pagespeed` | `luarocks install voxgig-sdk-pagespeed` |
