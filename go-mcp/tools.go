...
type Args struct {
	Entity string         `json:"entity" jsonschema:"run_pagespeed"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PagespeedSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "pagespeed_list",
		Description: "List records from Pagespeed. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "pagespeed_load",
		Description: "Load a single record from Pagespeed. " +
...
func runOp(client *sdk.PagespeedSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PagespeedSDK, name string) (sdk.PagespeedEntity, error) {
	switch strings.ToLower(name) {
	case "run_pagespeed":
		return client.RunPagespeed(nil), nil
